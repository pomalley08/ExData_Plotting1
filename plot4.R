...
# Title:  Week 1 Programming Assignment - Create plot4.png
...
feb_power <- arrange(feb_power, Date, Time)
...
# plot 3
with(feb_power, plot(date_time, Voltage, type = "l", xaxt = "n", 
...
# plot 4
with(feb_power, plot(date_time, Global_reactive_power, type = "l", xaxt = "n", 
